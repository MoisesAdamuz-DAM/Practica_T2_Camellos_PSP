...
public class Hilo  extends Thread {
	...
	private synchronized int tirada() //*2
	{	
		int resultado = 0;
	...
	public synchronized int obtenerPosicion(int pos)
	{
